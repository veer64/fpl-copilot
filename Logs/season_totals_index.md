...
H=6; decay 0.85 unless the config name says _d60/_d45. Chip-inclusive = path + bench@BB + capbonus@BB (TC2) where a BB was scheduled (pkg2h / phase-2 convention); wc/fh-only configs have no exogenous reads. The 3 pkg_d45 rows are newly indexed (they postdate the old index).
...
| 2023-24 | bbaware_wc33_bb34 | 6 | 0.85 | WC@33 BB@34 | **2218** | **2224** (r) | bench@GW34+3 TC2 cap@GW34+3 | +186 | +221 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2023_24_bbaware_wc33_bb34.parquet |
| 2023-24 | combined_d60 | 6 | 0.6 | WC@4,32 FH@29 BB@34 | **2218** | **2232** (r) | bench@GW34+11 TC2 cap@GW34+3 | +194 | +229 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2023_24_combined_d60.parquet |
| 2023-24 | combined_d85 | 6 | 0.85 | WC@4,32 FH@29 BB@34 | **2295** | **2301** (r) | bench@GW34+3 TC2 cap@GW34+3 | +263 | +298 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2023_24_combined_d85.parquet |
...
| 2023-24 | pkg_d45 | 6 | 0.45 | WC@4,32 FH@29 BB@34 | **2233** | **2282** (r) | bench@GW34+46 TC2 cap@GW34+3 | +244 | +279 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2023_24_pkg_d45.parquet |
...
| 2024-25 | bbaware_wc32_bb33 | 6 | 0.85 | WC@32 BB@33 | **2130** | **2154** (r) | bench@GW33+17 TC2 cap@GW33+7 | +0 | +146 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2024_25_bbaware_wc32_bb33.parquet |
| 2024-25 | combined_d60 | 6 | 0.6 | WC@4,31 FH@29 BB@33 | **2168** | **2204** (r) | bench@GW33+29 TC2 cap@GW33+7 | +50 | +196 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2024_25_combined_d60.parquet |
| 2024-25 | combined_d85 | 6 | 0.85 | WC@4,31 FH@29 BB@33 | **2129** | **2155** (r) | bench@GW33+19 TC2 cap@GW33+7 | +1 | +147 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2024_25_combined_d85.parquet |
...
| 2024-25 | pkg_d45 | 6 | 0.45 | WC@4,31 FH@29 BB@33 | **2118** | **2154** (r) | bench@GW33+29 TC2 cap@GW33+7 | +0 | +146 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2024_25_pkg_d45.parquet |
...
| 2025-26 | bbaware_wc32_bb33 | 6 | 0.85 | WC@32 BB@33 | **1958** | **1982** (r) | bench@GW33+11 TC2 cap@GW33+13 | +87 | +87 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2025_26_bbaware_wc32_bb33.parquet |
| 2025-26 | combined_d60 | 6 | 0.6 | WC@4,32 FH@34 BB@33 | **1965** | **2004** (r) | bench@GW33+26 TC2 cap@GW33+13 | +109 | +109 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2025_26_combined_d60.parquet |
| 2025-26 | combined_d85 | 6 | 0.85 | WC@4,32 FH@34 BB@33 | **2001** | **2024** (r) | bench@GW33+10 TC2 cap@GW33+13 | +129 | +129 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2025_26_combined_d85.parquet |
...
| 2025-26 | pkg_d45 | 6 | 0.45 | WC@4,32 FH@34 BB@33 | **2062** | **2099** (r) | bench@GW33+24 TC2 cap@GW33+13 | +204 | +204 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-20 | -- | chips/chiplog_2025_26_pkg_d45.parquet |
...
WC1 as named, WC2/FH2 in-sim, BB1+BB2 scheduled (bench-aware), TC1/TC2 exogenous reads. The system-as-configured cells are opening=base wc1=2 (WC1 rule of record GW2-3, p4 log section 12b).

| season | config | H | decay | chips scheduled | path total | chip-incl total | chip reads | vs avg (claimed) | vs avg (fplcache) | wf file | wf stamps | sim gates | run | flags | source |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2023-24 | opening=base wc1=2 | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2278** | **2299** (r) | bench@GW7+4 bench@GW34+8 TC2 cap@GW34+3 TC1 cap@GW6+6 | +261 | +296 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2023_24_base_wc2.parquet |
| 2023-24 | opening=base wc1=4 | 6 | 0.45 | WC@4,32 FH@29 BB@7,34 | **2238** | **2299** (r) | bench@GW7+6 bench@GW34+46 TC2 cap@GW34+3 TC1 cap@GW6+6 | +261 | +296 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2023_24_base_wc4.parquet |
| 2023-24 | opening=base wc1=6 | 6 | 0.45 | WC@6,32 FH@29 BB@7,34 | **2306** | **2348** (r) | bench@GW7+5 bench@GW34+33 TC2 cap@GW34+3 TC1 cap@GW11+1 | +310 | +345 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2023_24_base_wc6.parquet |
| 2023-24 | opening=base wc1=8 | 6 | 0.45 | WC@8,32 FH@29 BB@7,34 | **2259** | **2331** (r) | bench@GW7+19 bench@GW34+44 TC2 cap@GW34+3 TC1 cap@GW6+6 | +293 | +328 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2023_24_base_wc8.parquet |
| 2023-24 | opening=p1 wc1=2 | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2273** | **2294** (r) | bench@GW7+4 bench@GW34+8 TC2 cap@GW34+3 TC1 cap@GW6+6 | +256 | +291 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2023_24_p1_wc2.parquet |
| 2023-24 | opening=p1 wc1=4 | 6 | 0.45 | WC@4,32 FH@29 BB@7,34 | **2263** | **2297** (r) | bench@GW7+6 bench@GW34+19 TC2 cap@GW34+3 TC1 cap@GW6+6 | +259 | +294 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2023_24_p1_wc4.parquet |
| 2023-24 | opening=p1 wc1=6 | 6 | 0.45 | WC@6,32 FH@29 BB@7,34 | **2257** | **2274** (r) | bench@GW7+5 bench@GW34+8 TC2 cap@GW34+3 TC1 cap@GW11+1 | +236 | +271 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2023_24_p1_wc6.parquet |
| 2023-24 | opening=p1 wc1=8 | 6 | 0.45 | WC@8,32 FH@29 BB@7,34 | **2176** | **2232** (r) | bench@GW7+3 bench@GW34+44 TC2 cap@GW34+3 TC1 cap@GW6+6 | +194 | +229 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2023_24_p1_wc8.parquet |
| 2024-25 | opening=base wc1=2 | 6 | 0.45 | WC@2,31 FH@29 BB@7,33 | **2255** | **2301** (r) | bench@GW7+5 bench@GW33+25 TC2 cap@GW33+7 TC1 cap@GW18+9 | +147 | +293 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2024_25_base_wc2.parquet |
| 2024-25 | opening=base wc1=4 | 6 | 0.45 | WC@4,31 FH@29 BB@7,33 | **2385** | **2445** (r) | bench@GW7+19 bench@GW33+25 TC2 cap@GW33+7 TC1 cap@GW18+9 | +291 | +437 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2024_25_base_wc4.parquet |
| 2024-25 | opening=base wc1=6 | 6 | 0.45 | WC@6,31 FH@29 BB@7,33 | **2057** | **2107** (r) | bench@GW7+8 bench@GW33+26 TC2 cap@GW33+7 TC1 cap@GW18+9 | -47 | +99 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2024_25_base_wc6.parquet |
| 2024-25 | opening=base wc1=8 | 6 | 0.45 | WC@8,31 FH@29 BB@7,33 | **2148** | **2208** (r) | bench@GW7+12 bench@GW33+32 TC2 cap@GW33+7 TC1 cap@GW18+9 | +54 | +200 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2024_25_base_wc8.parquet |
| 2024-25 | opening=p1 wc1=2 | 6 | 0.45 | WC@2,31 FH@29 BB@9,33 | **2324** | **2368** (r) | bench@GW9+5 bench@GW33+23 TC2 cap@GW33+7 TC1 cap@GW18+9 | +214 | +360 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2024_25_p1_wc2.parquet |
| 2024-25 | opening=p1 wc1=4 | 6 | 0.45 | WC@4,31 FH@29 BB@9,33 | **2105** | **2162** (r) | bench@GW9+12 bench@GW33+29 TC2 cap@GW33+7 TC1 cap@GW18+9 | +8 | +154 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2024_25_p1_wc4.parquet |
| 2024-25 | opening=p1 wc1=6 | 6 | 0.45 | WC@6,31 FH@29 BB@9,33 | **2164** | **2203** (r) | bench@GW9+5 bench@GW33+18 TC2 cap@GW33+7 TC1 cap@GW18+9 | +49 | +195 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2024_25_p1_wc6.parquet |
| 2024-25 | opening=p1 wc1=8 | 6 | 0.45 | WC@8,31 FH@29 BB@9,33 | **2100** | **2137** (r) | bench@GW9+9 bench@GW33+12 TC2 cap@GW33+7 TC1 cap@GW18+9 | -17 | +129 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2024_25_p1_wc8.parquet |
| 2025-26 | opening=base wc1=2 | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2156** | **2219** (r) | bench@GW10+11 bench@GW33+23 TC2 cap@GW33+13 TC1 cap@GW17+16 | +324 | +324 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2025_26_base_wc2.parquet |
| 2025-26 | opening=base wc1=4 | 6 | 0.45 | WC@4,32 FH@34 BB@10,33 | **2069** | **2133** (r) | bench@GW10+8 bench@GW33+27 TC2 cap@GW33+13 TC1 cap@GW17+16 | +238 | +238 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2025_26_base_wc4.parquet |
| 2025-26 | opening=base wc1=6 | 6 | 0.45 | WC@6,32 FH@34 BB@10,33 | **2031** | **2084** (r) | bench@GW10+7 bench@GW33+17 TC2 cap@GW33+13 TC1 cap@GW17+16 | +189 | +189 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2025_26_base_wc6.parquet |
| 2025-26 | opening=base wc1=8 | 6 | 0.45 | WC@8,32 FH@34 BB@10,33 | **2072** | **2148** (r) | bench@GW10+19 bench@GW33+28 TC2 cap@GW33+13 TC1 cap@GW17+16 | +253 | +253 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | -- | 2026-08-21 | -- | p1/fslog_2025_26_base_wc8.parquet |
| 2025-26 | opening=p1 wc1=2 | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2161** | **2224** (r) | bench@GW10+11 bench@GW33+23 TC2 cap@GW33+13 TC1 cap@GW17+16 | +329 | +329 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2025_26_p1_wc2.parquet |
| 2025-26 | opening=p1 wc1=4 | 6 | 0.45 | WC@4,32 FH@34 BB@10,33 | **2038** | **2104** (r) | bench@GW10+12 bench@GW33+25 TC2 cap@GW33+13 TC1 cap@GW17+16 | +209 | +209 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2025_26_p1_wc4.parquet |
| 2025-26 | opening=p1 wc1=6 | 6 | 0.45 | WC@6,32 FH@34 BB@10,33 | **2035** | **2091** (r) | bench@GW10+13 bench@GW33+14 TC2 cap@GW33+13 TC1 cap@GW17+16 | +196 | +196 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2025_26_p1_wc6.parquet |
| 2025-26 | opening=p1 wc1=8 | 6 | 0.45 | WC@8,32 FH@34 BB@10,33 | **2094** | **2156** (r) | bench@GW10+19 bench@GW33+14 TC2 cap@GW33+13 TC1 cap@GW17+16 | +261 | +261 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | opening_horizon | 2026-08-21 | -- | p1/fslog_2025_26_p1_wc8.parquet |

## P3 EARLY-HIT GRID (data/p1/p3log_*)

Full-system config + EARLY_HIT_DISCOUNT_ACTIVE at the named bar. Measured and DECLINED; bar=4 references are the fslog rows above.

| season | config | H | decay | chips scheduled | path total | chip-incl total | chip reads | vs avg (claimed) | vs avg (fplcache) | wf file | wf stamps | sim gates | run | flags | source |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2023-24 | wc1=2 bar=1 | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2205** | **2256** (r) | bench@GW7+9 bench@GW34+33 TC2 cap@GW34+3 TC1 cap@GW6+6 | +218 | +253 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=1 | 2026-08-21 | -- | p1/p3log_2023_24_wc2_bar1.parquet |
| 2023-24 | wc1=2 bar=2 | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2331** | **2385** (r) | bench@GW7+18 bench@GW34+27 TC2 cap@GW34+3 TC1 cap@GW6+6 | +347 | +382 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=2 | 2026-08-21 | -- | p1/p3log_2023_24_wc2_bar2.parquet |
| 2023-24 | wc1=2 bar=3 | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2264** | **2299** (r) | bench@GW7+18 bench@GW34+8 TC2 cap@GW34+3 TC1 cap@GW6+6 | +261 | +296 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=3 | 2026-08-21 | -- | p1/p3log_2023_24_wc2_bar3.parquet |
| 2023-24 | wc1=6 bar=1 | 6 | 0.45 | WC@6,32 FH@29 BB@7,34 | **2261** | **2307** (r) | bench@GW7+9 bench@GW34+33 TC2 cap@GW34+3 TC1 cap@GW11+1 | +269 | +304 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=1 | 2026-08-21 | -- | p1/p3log_2023_24_wc6_bar1.parquet |
| 2023-24 | wc1=6 bar=2 | 6 | 0.45 | WC@6,32 FH@29 BB@7,34 | **2232** | **2254** (r) | bench@GW7+10 bench@GW34+8 TC2 cap@GW34+3 TC1 cap@GW11+1 | +216 | +251 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=2 | 2026-08-21 | -- | p1/p3log_2023_24_wc6_bar2.parquet |
| 2023-24 | wc1=6 bar=3 | 6 | 0.45 | WC@6,32 FH@29 BB@7,34 | **2196** | **2237** (r) | bench@GW7+6 bench@GW34+31 TC2 cap@GW34+3 TC1 cap@GW11+1 | +199 | +234 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=3 | 2026-08-21 | -- | p1/p3log_2023_24_wc6_bar3.parquet |
| 2024-25 | wc1=2 bar=1 | 6 | 0.45 | WC@2,31 FH@29 BB@7,33 | **2227** | **2281** (r) | bench@GW7+18 bench@GW33+20 TC2 cap@GW33+7 TC1 cap@GW18+9 | +127 | +273 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=1 | 2026-08-21 | -- | p1/p3log_2024_25_wc2_bar1.parquet |
| 2024-25 | wc1=2 bar=2 | 6 | 0.45 | WC@2,31 FH@29 BB@7,33 | **2246** | **2295** (r) | bench@GW7+19 bench@GW33+14 TC2 cap@GW33+7 TC1 cap@GW18+9 | +141 | +287 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=2 | 2026-08-21 | -- | p1/p3log_2024_25_wc2_bar2.parquet |
| 2024-25 | wc1=2 bar=3 | 6 | 0.45 | WC@2,31 FH@29 BB@7,33 | **2195** | **2255** (r) | bench@GW7+20 bench@GW33+24 TC2 cap@GW33+7 TC1 cap@GW18+9 | +101 | +247 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=3 | 2026-08-21 | -- | p1/p3log_2024_25_wc2_bar3.parquet |
| 2024-25 | wc1=6 bar=1 | 6 | 0.45 | WC@6,31 FH@29 BB@7,33 | **2067** | **2128** (r) | bench@GW7+19 bench@GW33+26 TC2 cap@GW33+7 TC1 cap@GW18+9 | -26 | +120 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=1 | 2026-08-21 | -- | p1/p3log_2024_25_wc6_bar1.parquet |
| 2024-25 | wc1=6 bar=2 | 6 | 0.45 | WC@6,31 FH@29 BB@7,33 | **2159** | **2201** (r) | bench@GW7+14 bench@GW33+12 TC2 cap@GW33+7 TC1 cap@GW18+9 | +47 | +193 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=2 | 2026-08-21 | -- | p1/p3log_2024_25_wc6_bar2.parquet |
| 2024-25 | wc1=6 bar=3 | 6 | 0.45 | WC@6,31 FH@29 BB@7,33 | **2160** | **2201** (r) | bench@GW7+13 bench@GW33+12 TC2 cap@GW33+7 TC1 cap@GW18+9 | +47 | +193 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=3 | 2026-08-21 | -- | p1/p3log_2024_25_wc6_bar3.parquet |
| 2025-26 | wc1=2 bar=1 | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2080** | **2157** (r) | bench@GW10+18 bench@GW33+30 TC2 cap@GW33+13 TC1 cap@GW17+16 | +262 | +262 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=1 | 2026-08-21 | -- | p1/p3log_2025_26_wc2_bar1.parquet |
| 2025-26 | wc1=2 bar=2 | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2093** | **2159** (r) | bench@GW10+18 bench@GW33+19 TC2 cap@GW33+13 TC1 cap@GW17+16 | +264 | +264 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=2 | 2026-08-21 | -- | p1/p3log_2025_26_wc2_bar2.parquet |
| 2025-26 | wc1=2 bar=3 | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2156** | **2219** (r) | bench@GW10+11 bench@GW33+23 TC2 cap@GW33+13 TC1 cap@GW17+16 | +324 | +324 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=3 | 2026-08-21 | -- | p1/p3log_2025_26_wc2_bar3.parquet |
| 2025-26 | wc1=6 bar=1 | 6 | 0.45 | WC@6,32 FH@34 BB@10,33 | **2075** | **2132** (r) | bench@GW10+15 bench@GW33+13 TC2 cap@GW33+13 TC1 cap@GW17+16 | +237 | +237 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=1 | 2026-08-21 | -- | p1/p3log_2025_26_wc6_bar1.parquet |
| 2025-26 | wc1=6 bar=2 | 6 | 0.45 | WC@6,32 FH@34 BB@10,33 | **2047** | **2106** (r) | bench@GW10+11 bench@GW33+19 TC2 cap@GW33+13 TC1 cap@GW17+16 | +211 | +211 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=2 | 2026-08-21 | -- | p1/p3log_2025_26_wc6_bar2.parquet |
| 2025-26 | wc1=6 bar=3 | 6 | 0.45 | WC@6,32 FH@34 BB@10,33 | **2022** | **2079** (r) | bench@GW10+9 bench@GW33+19 TC2 cap@GW33+13 TC1 cap@GW17+16 | +184 | +184 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | early_hit_bar=3 | 2026-08-21 | -- | p1/p3log_2025_26_wc6_bar3.parquet |

## P5 OPTIMIZER-WINS ARMS (data/p1/p5log_*)

Full-system wc2 config + bench-order / XI-tiebreak gates. Measured and DECLINED (noise-free paired paths).

| season | config | H | decay | chips scheduled | path total | chip-incl total | chip reads | vs avg (claimed) | vs avg (fplcache) | wf file | wf stamps | sim gates | run | flags | source |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2023-24 | arm=bench | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2271** | **2299** (r) | bench@GW7+4 bench@GW34+15 TC2 cap@GW34+3 TC1 cap@GW6+6 | +261 | +296 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | bench_order | 2026-08-21 | -- | p1/p5log_2023_24_bench.parquet |
| 2023-24 | arm=both | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2271** | **2299** (r) | bench@GW7+11 bench@GW34+8 TC2 cap@GW34+3 TC1 cap@GW6+6 | +261 | +296 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | bench_order xi_p60 | 2026-08-21 | -- | p1/p5log_2023_24_both.parquet |
| 2023-24 | arm=xi | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2271** | **2299** (r) | bench@GW7+11 bench@GW34+8 TC2 cap@GW34+3 TC1 cap@GW6+6 | +261 | +296 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | xi_p60 | 2026-08-21 | -- | p1/p5log_2023_24_xi.parquet |
| 2024-25 | arm=bench | 6 | 0.45 | WC@2,31 FH@29 BB@7,33 | **2248** | **2294** (r) | bench@GW7+5 bench@GW33+25 TC2 cap@GW33+7 TC1 cap@GW18+9 | +140 | +286 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | bench_order | 2026-08-21 | -- | p1/p5log_2024_25_bench.parquet |
| 2024-25 | arm=both | 6 | 0.45 | WC@2,31 FH@29 BB@7,33 | **2236** | **2294** (r) | bench@GW7+5 bench@GW33+37 TC2 cap@GW33+7 TC1 cap@GW18+9 | +140 | +286 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | bench_order xi_p60 | 2026-08-21 | -- | p1/p5log_2024_25_both.parquet |
| 2024-25 | arm=xi | 6 | 0.45 | WC@2,31 FH@29 BB@7,33 | **2243** | **2301** (r) | bench@GW7+5 bench@GW33+37 TC2 cap@GW33+7 TC1 cap@GW18+9 | +147 | +293 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | xi_p60 | 2026-08-21 | -- | p1/p5log_2024_25_xi.parquet |
| 2025-26 | arm=bench | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2152** | **2214** (r) | bench@GW10+11 bench@GW33+22 TC2 cap@GW33+13 TC1 cap@GW17+16 | +319 | +319 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | bench_order | 2026-08-21 | -- | p1/p5log_2025_26_bench.parquet |
| 2025-26 | arm=both | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2154** | **2214** (r) | bench@GW10+5 bench@GW33+26 TC2 cap@GW33+13 TC1 cap@GW17+16 | +319 | +319 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | bench_order xi_p60 | 2026-08-21 | -- | p1/p5log_2025_26_both.parquet |
| 2025-26 | arm=xi | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2159** | **2219** (r) | bench@GW10+5 bench@GW33+26 TC2 cap@GW33+13 TC1 cap@GW17+16 | +324 | +324 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | xi_p60 | 2026-08-21 | -- | p1/p5log_2025_26_xi.parquet |

## TEAM-NEWS ORACLE -- DELIBERATE LEAKAGE (data/teamnews)

oracle_minutes_active=True: realized minutes injected into predictions. These rows are MEASUREMENTS of an upper bound, never baselines, never adoptable, comparable only to their reference cell (fslog base_wc2).

| season | config | H | decay | chips scheduled | path total | chip-incl total | chip reads | vs avg (claimed) | vs avg (fplcache) | wf file | wf stamps | sim gates | run | flags | source |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2023-24 | A step0-only oracle | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2306** | **2364** (r) | bench@GW7+13 bench@GW34+36 TC2 cap@GW34+3 TC1 cap@GW6+6 | +326 | +361 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2023_24_A.parquet |
| 2023-24 | B calendar-knowable mask | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2222** | **2253** (r) | bench@GW7+4 bench@GW34+18 TC2 cap@GW34+3 TC1 cap@GW6+6 | +215 | +250 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2023_24_B.parquet |
| 2023-24 | C Guardian-reported mask | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2270** | **2299** (r) | bench@GW7+4 bench@GW34+16 TC2 cap@GW34+3 TC1 cap@GW6+6 | +261 | +296 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2023_24_C.parquet |
| 2023-24 | full-horizon oracle | 6 | 0.45 | WC@2,32 FH@29 BB@7,34 | **2424** | **2493** (r) | bench@GW7+15 bench@GW34+39 TC2 cap@GW34+9 TC1 cap@GW6+6 | +455 | +490 | walkforward_h6_2023_24.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2023_24.parquet |
| 2024-25 | A step0-only oracle | 6 | 0.45 | WC@2,31 FH@29 BB@7,33 | **2170** | **2210** (r) | bench@GW7+15 bench@GW33+13 TC2 cap@GW33+3 TC1 cap@GW18+9 | +56 | +202 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2024_25_A.parquet |
| 2024-25 | B calendar-knowable mask | 6 | 0.45 | WC@2,31 FH@29 BB@7,33 | **2115** | **2181** (r) | bench@GW7+13 bench@GW33+37 TC2 cap@GW33+7 TC1 cap@GW18+9 | +27 | +173 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2024_25_B.parquet |
| 2024-25 | C Guardian-reported mask | 6 | 0.45 | WC@2,31 FH@29 BB@7,33 | **2133** | **2194** (r) | bench@GW7+13 bench@GW33+32 TC2 cap@GW33+7 TC1 cap@GW18+9 | +40 | +186 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2024_25_C.parquet |
| 2024-25 | full-horizon oracle | 6 | 0.45 | WC@2,31 FH@29 BB@7,33 | **2364** | **2406** (r) | bench@GW7+13 bench@GW33+17 TC2 cap@GW33+3 TC1 cap@GW18+9 | +252 | +398 | walkforward_h6_2024_25.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2024_25.parquet |
| 2025-26 | A step0-only oracle | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2277** | **2345** (r) | bench@GW10+19 bench@GW33+20 TC2 cap@GW33+13 TC1 cap@GW17+16 | +450 | +450 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2025_26_A.parquet |
| 2025-26 | B calendar-knowable mask | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2180** | **2249** (r) | bench@GW10+15 bench@GW33+25 TC2 cap@GW33+13 TC1 cap@GW17+16 | +354 | +354 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2025_26_B.parquet |
| 2025-26 | C Guardian-reported mask | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2154** | **2218** (r) | bench@GW10+11 bench@GW33+24 TC2 cap@GW33+13 TC1 cap@GW17+16 | +323 | +323 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2025_26_C.parquet |
| 2025-26 | full-horizon oracle | 6 | 0.45 | WC@2,32 FH@34 BB@10,33 | **2251** | **2313** (r) | bench@GW10+17 bench@GW33+16 TC2 cap@GW33+13 TC1 cap@GW17+16 | +418 | +418 | walkforward_h6_2025_26.parquet | av=T d1=T blend=T dgw=per_fixture synth=F | ORACLE | 2026-08-22 | LEAKAGE INSTRUMENT -- never adopt, never a baseline | teamnews/oraclelog_2025_26.parquet |
