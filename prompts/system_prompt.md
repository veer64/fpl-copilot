...
- No tables and no `rendered` block unless the user asks for the full breakdown or for detail; offer it in one clause. When they ask, give all of it: every term, the zeros, the labels, the fixture line.
