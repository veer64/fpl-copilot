...
ARM_ORDER = ["baseline8", "props", "hmin", "both", "penfix", "cal", "cal_penfix", "bonusow", "bonusdel", "leakfix", "gap0"]
LABEL = {"baseline8": "baseline re-run from GW8 (like-for-like check)",
         ...
         "gap0": "J. leak-fixed canonical + solver MIP gap 0 (commits e04fb72, 37ad782) -- reference candidate with --tc2 (2026-08-27)",
...
def cap_pred_arm(season, arm):
    ...
    if arm in ("props", "both", "penfix", "cal", "cal_penfix", "bonusow", "bonusdel", "leakfix", "gap0") and p.exists():
