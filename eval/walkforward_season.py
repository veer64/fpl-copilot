...
# Seasons whose scoring includes the defensive-contribution rule. 2026-27
# added at the 2026-08-31 ADOPTION of the FPL-official DC source -- a
# JUDGEMENT CALL, not a passed pre-registration: the pre-registered swap test
# FAILED on unsliced Brier (Logs/dc_source_swap_prereg.md) and the exploratory
# re-measurement (Logs/dc_source_swap_exploratory_log.md) changed the endpoint
# after that fail. Adoption is on correctness (FPL awards the points; the old
# hold's #21 evidence was a goalkeeper artefact). The season-parametric
# official source, defensive.DC_RULE_SEASONS and the (source, season) cache
# key moved in the same commit, as the hold required.
DC_SEASONS = {"2025-26", "2026-27"}
